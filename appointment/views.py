...
class AppointmentView(View):
    ...
    # [--- 1 вариант. Отправляем письмо с помощью send_mail
        ...
        #     from_email='roguesinister@yandex.ru', # здесь указываете почту, с которой будете отправлять (об этом попозже)
        #     recipient_list=['roguesinister@mail.ru'] # здесь список получателей. Например, секретарь, сам врач и так далее
        # )
    ...
    # [--- 2 вариант. Отправляем на почту красивенько свёрстанный HTML-шаблон самой компании.
        ...
        #     from_email='roguesinister@yandex.ru',
        #     to=['roguesinister@mail.ru'], # это то же, что и recipients_list
        # )
