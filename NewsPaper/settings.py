...
MIDDLEWARE = [
    ...
    # # кэширование всего сайта (не страницы)
...
# [-- D7.3. Кэширование в Django
CACHES = {
    'default': {
        #'TIMEOUT': 60, # добавляем стандартное время ожидания в минуту (по умолчанию это 5 минут — 300 секунд) # для кэш-я всего сайта целиком
